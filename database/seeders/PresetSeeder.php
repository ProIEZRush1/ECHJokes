    ...
    public function run(): void
    {
        $presets = [
            [
                ...
                'voice' => 'ash',
                'style' => 'Formal y autoritario, con tono de queja contenida',
                'category' => 'vecinos',
                'sort_order' => 1,
            ],
            [
                ...
                'voice' => 'coral',
                'style' => 'Profesional y preocupada, tono urgente pero educado',
                'category' => 'banco',
                'sort_order' => 2,
            ],
            [
                ...
                'voice' => 'coral',
                'style' => 'Muy entusiasmada y emocionada, habla rapido con energia',
                'category' => 'mascotas',
                'sort_order' => 3,
            ],
            [
                ...
                'voice' => 'ash',
                'style' => 'Super animado y energetico, como conductor de radio en vivo',
                'category' => 'premios',
                'sort_order' => 4,
            ],
            [
                ...
                'voice' => 'ash',
                'style' => 'Confundido pero insistente, cada vez mas frustrado',
                'category' => 'comida',
                'sort_order' => 5,
            ],
            [
                ...
                'voice' => 'coral',
                'style' => 'Elegante y exclusiva, como vendedora de lujo que todo lo dice en serio',
                'category' => 'premios',
                'sort_order' => 6,
            ],
            [
                ...
                'voice' => 'ash',
                'style' => 'Enojado y dramatico, exagera todo con indignacion',
                'category' => 'vecinos',
                'sort_order' => 7,
            ],
            [
                ...
                'style' => 'Amable y nerviosa, indecisa, cambia de opinion constantemente',
                'voice' => 'coral',
                'category' => 'servicios',
                'sort_order' => 8,
            ],
