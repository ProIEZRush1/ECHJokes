...
class AdminApiController extends Controller
{
    ...
    {
        $query = JokeCall::query()->with('user:id,name,email,referred_by_user_id,subscription_plan')->latest();
    ...
    public function createPreset(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'voice' => 'required|in:ash,ballad,verse,echo,coral,sage,shimmer',
    ...
    public function updatePreset(Request $request, Preset $preset): JsonResponse
    {
        $data = $request->validate([
            ...
            'scenario' => 'string',
            'character' => 'nullable|string|max:200',
            'voice' => 'in:ash,ballad,verse,echo,coral,sage,shimmer',
            'category' => 'nullable|string|max:50',
            'is_active' => 'boolean',
            'sort_order' => 'integer',
        ]);
