...
class InboundCallController extends Controller
{
    public function handle(Request $request): Response
    {
        ...
        $jokes = [
            'Oye, sabias que si le pones lentes a un pez se convierte en pez con vista? Bueno, eso no es cierto, pero que chistoso seria no? Gracias por llamar a ECH Jokes, la mejor app de bromas telefonicas con inteligencia artificial. Visitanos en ech jokes punto com. Adios!',
            'Hola! Sabias que los gatos planean dominar el mundo? Lo se porque mi gato me mira raro cuando como atun. En fin, gracias por llamar a ECH Jokes! Si quieres hacer bromas telefonicas con IA, visitanos en ech jokes punto com. Hasta luego!',
            'Bueno? Ah hola! Fijate que ayer le pregunte a la IA que es el amor y me dijo error cuatro cero cuatro. Ni la tecnologia lo entiende. Gracias por llamar a ECH Jokes, bromas telefonicas con inteligencia artificial. Ech jokes punto com. Bye!',
        ];
